			...
			<ul id = "mainmenu">
				...
				<li><a>마이페이지</a>
					<ul class = "submenu">
						...
						<li><a onclick="idnull()" style="cursor:pointer;">매칭정보수정</a></li>
						<li><a onclick="idnull()" style="cursor:pointer;">이상형정보수정</a></li>
						<%} else { %>
						<li><a href="#">개인정보수정</a></li>
						<li><a href="#">매칭정보수정</a></li>
	...
	<BODY>
		<div id ="content">
			...
			<div id = "divmenu" style = "width : 1300px; height : 50px; float : left;">
				...
				<input type="button" value= "목록" onclick = "location.href = 'bbsall'" style = "width : 80px; height : 35px; font-size: 15px;">
				<%}else{ %>
